...
export const Footer: React.FC = () => {
  return (
    <footer className="py-16 border-t border-slate-200 bg-slate-50 relative z-10">
      <div className="container mx-auto px-6 text-center">
        <div className="text-3xl font-display text-slate-500 mb-6 tracking-widest opacity-50">PORTFOLIO</div>
        <div className="w-12 h-px bg-slate-300 mx-auto mb-8"></div>
        <div className="flex justify-center gap-8 text-xs text-slate-600 font-sans tracking-[0.2em] uppercase mb-8">
